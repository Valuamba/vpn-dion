...
from ..models.vpn_subscription_vpn_items_item_instance_data_country_data import (
    VpnSubscriptionVpnItemsItemInstanceDataCountryData,
)
from ..models.vpn_subscription_vpn_items_item_instance_data_protocols_data_item import (
    VpnSubscriptionVpnItemsItemInstanceDataProtocolsDataItem,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="VpnSubscriptionVpnItemsItemInstanceData")


@attr.s(auto_attribs=True)
class VpnSubscriptionVpnItemsItemInstanceData:
    """
    Attributes:
        ip_address (str):
        name (str):
        protocols (List[int]):
        protocols_data (List[VpnSubscriptionVpnItemsItemInstanceDataProtocolsDataItem]):
        is_online (bool):
        pkid (Union[Unset, int]):
        country (Union[Unset, None, int]):
        country_data (Union[Unset, VpnSubscriptionVpnItemsItemInstanceDataCountryData]):
    """
    ...
    country_data: Union[Unset, VpnSubscriptionVpnItemsItemInstanceDataCountryData] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for protocols_data_item_data in _protocols_data:
            protocols_data_item = VpnSubscriptionVpnItemsItemInstanceDataProtocolsDataItem.from_dict(
                protocols_data_item_data
            )
        ...
        if isinstance(_country_data, Unset):
            ...
            country_data = VpnSubscriptionVpnItemsItemInstanceDataCountryData.from_dict(_country_data)

        vpn_subscription_vpn_items_item_instance_data = cls(
            ip_address=ip_address,
            name=name,
            protocols=protocols,
            protocols_data=protocols_data,
        ...
        vpn_subscription_vpn_items_item_instance_data.additional_properties = d
        return vpn_subscription_vpn_items_item_instance_data
