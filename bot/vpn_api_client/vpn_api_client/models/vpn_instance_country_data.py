...
T = TypeVar("T", bound="VpnInstanceCountryData")


@attr.s(auto_attribs=True)
class VpnInstanceCountryData:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        vpn_instance_country_data = cls(
            pkid=pkid,
            country=country,
            discount_percentage=discount_percentage,
        )

        vpn_instance_country_data.additional_properties = d
        return vpn_instance_country_data
